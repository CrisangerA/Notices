        ...
        const Notes = notesReverce.map((note, i) =>{
            return(
                <tr key={i}>
                    ...
                    <td>{note.category}</td>
                    <td>
                        <button type="button" className="btn btn-warning d-inline mx-1" onClick={() => this.editNotes(note._id)}>
                            <i className="fas fa-edit"></i>
                        </button>
                        <button type="button" className="btn btn-danger d-inline mx-1" onClick={() => this.deleteNotes(note._id)}>
                            ...
                            <div className="modal-content">
                                <form onSubmit={this.addNotes}>
                                    <div className="card-body">
                                        <textarea id="description" placeholder="Descripción" cols="30" rows="4" className="form-control mb-1" onChange={this.handleChange} value={this.state.description}/>
